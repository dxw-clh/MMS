...
<body>
<form action="${path}doctor/addOrEdit" method="post" class="definewidth m20">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
        	...
        	<input type="radio" name="sex" value="0" ${doctor.sex == 0 ? 'checked':''} />男&nbsp;&nbsp;&nbsp;
    ...
    <tr>
    	...
    	value='<fmt:formatDate value="${doctor.birthday}" pattern = "YYYY-MM-dd HH:mm:ss"/>'/></td>
    </tr>
    <tr>
